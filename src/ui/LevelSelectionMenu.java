...
public class LevelSelectionMenu extends MouseAdapter {
    ...
    public void render(Graphics g) {
        ...
        g.drawString("LEVEL 1 (Dễ)", level1Button.x + 35, level1Button.y + 35);
        ...
        g.drawString("LEVEL 2 (Trung bình)", level2Button.x + 10, level2Button.y + 35);
        ...
        g.drawString("LEVEL 3 (Khó)", level3Button.x + 30, level3Button.y + 35);
